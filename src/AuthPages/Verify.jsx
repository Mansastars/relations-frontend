      ...
      <div className="bg-white shadow-md rounded-2xl p-8 max-w-md w-full">
        ...
        {verificationStatus === "success" && (
          <div className="text-center">
            ...
            <p className=" text-dark-blue mt-3">
        ...
        {verificationStatus === "error" && (
          <div className="text-center">
            ...
            <div>
              <span className=" text-dark-blue mt-5">
                The verification link has expired or already been used. Please
                log in again to resend the verification email.
                <p className=" mt-10 text-gray-500">
                  Or contact support at{" "}
                  <a
                    href="mailto:service@mansastars.com"
                    className=" text-mansa-blue"
                  >
                    service@mansastars.com
                  </a>{" "}
                  if issue persists.{" "}
                </p>
              </span>
