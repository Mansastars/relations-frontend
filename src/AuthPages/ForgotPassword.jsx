...
import checkPasswordStrength from "../components/ReusableComponents/checkPasswordStrength";
    ...
    try {
      if (canSubmit) {
        const response = await api.post(
          `users/reset-password/${verificationToken}`,
          userData
        );
    ...
    <div className=" mx-2 flex justify-center relative top-10 ">
      <div className="bg-white px-5 py-5 flex flex-col mt-10 mb-5 rounded-2xl h-full w-1/2 max-lg:w-[70%] max-md:w-[90%]">
        <div className=" flex flex-col justify-center items-center gap-5 h-fit ">
          <h1 className=" text-dark-blue font-bold text-4xl text-center mb-5">
            Reset Password
          </h1>
          <form
