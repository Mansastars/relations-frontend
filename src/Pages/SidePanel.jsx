...
import dashboard from "../assets/SidePanelIcons/dashboard.svg";
import support from "../assets/SidePanelIcons/support.svg";
import profile from "../assets/SidePanelIcons/profile.svg";
import logout from "../assets/SidePanelIcons/logout.svg";
import link from "../assets/SidePanelIcons/link.svg";
import Star from "../assets/SidePanelIcons/Star.svg";
import Billing from "../assets/SidePanelIcons/Billing.svg";
import contacts from "../assets/SidePanelIcons/contacts.svg";
import { SidebarItem } from "../components/Reusables";
    ...
    >
      ...
      <div className={` ${isOpen ? "" : "mt-4"} pt-4 text-center`}>
        ...
        <button onClick={togglePanel} className="focus:outline-none px-4">
          {isOpen ? (
            ...
            <ArrowLeftCircle
              size={30}
              className=" text-white hover:text-mansa-blue mt-8 max-[800px]:hidden"
            />
          )}
        </button>
      </div>
      ...
      >
        <ul className=" space-y-4">
          <li
            className={`${
              location.pathname === "/alldashboards"
                ? "bg-mansa-blue"
                : "hover:bg-mansa-blue"
          ...
          >
            ...
            >
              ...
              {isOpen && (
                <span className=" font-bold text-base">Dashboards</span>
              )}
            </Link>
          </li>
          ...
          >
            <a
              href="https://community.mansastars.com/home"
              className={`flex items-center w-full px-4 py-2 ${
                isOpen ? " space-x-6" : "gap-0 space-x-0"
              } `}
            >
              ...
              {isOpen && (
                <span className=" font-bold text-base">VC/Founder Network</span>
              )}
            </a>
          </li>
      ...
      <div
        className={`mt-auto mb-3 hover:bg-mansa-blue transition-all duration-200 cursor-pointer`}
      >
        <button
