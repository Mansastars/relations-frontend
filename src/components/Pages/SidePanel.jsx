        ...
        >
            ...
            <div className={` ${isOpen ? '' : 'mt-4'} pt-4 text-center`}>
                ...
                <button onClick={togglePanel} className="focus:outline-none px-4">
                    {isOpen ? (
                        ...
                        <MenuIcon size={32} className=' text-white hover:text-mansa-blue mt-8 max-sm:hidden' />
                    )}
                </button>
            </div>
            {/* Navigation Items */}
            <div className={`flex w-full flex-col  ${isOpen ? ' justify-start mt-5 mb-5' : ' items-center justify-center mt-2 pb-5'} `}>
                <ul className=' space-y-4'>
                    <li className={` ${isOpen ? 'px-4' : 'px-4 gap-0'}  py-2 hover:bg-mansa-blue transition-all duration-200 cursor-pointer`}>
                        <Link to="/alldashboards" className={`flex items-center ${isOpen ? ' space-x-6' : 'space-x-0'} `}>
                            <img src={dashboard} alt="" className={`w-8 h-6 block`} />
                            {isOpen && <span className=' font-bold text-base'>Dashboards</span>}
                        </Link>
                    </li>

                    <li className={` ${isOpen ? 'px-4' : 'px-4'}  py-2 hover:bg-mansa-blue transition-all duration-200 cursor-pointer`}>
                        <Link to="/profile" className={`flex items-center ${isOpen ? ' space-x-6' : 'space-x-0'} `}>
                    ...
                    <li className={` ${isOpen ? 'px-4' : 'px-4'}  py-2 hover:bg-mansa-blue transition-all duration-200 cursor-pointer`}>
                        <Link to="" className={`flex items-center ${isOpen ? ' space-x-6' : 'space-x-0'} `}>
                    ...
                    <li className={` ${isOpen ? 'px-4' : 'px-4'}  py-2 hover:bg-mansa-blue transition-all duration-200 cursor-pointer`}>
                        <a href='mailto:service@mansastars.com' target="_top" className={`flex items-center ${isOpen ? ' space-x-6' : 'space-x-0'} `}>
                    ...
                    <li className={` ${isOpen ? 'px-4' : 'px-4'}  py-2 hover:bg-mansa-blue transition-all duration-200 cursor-pointer`}>
                        <a href='https://www.mansastars.com/monthly-investor-update' className={`flex items-center ${isOpen ? ' space-x-6' : 'space-x-0'} `}>
                    ...
                    <li className={` ${isOpen ? 'px-4' : 'px-4'}  py-2 hover:bg-mansa-blue transition-all duration-200 cursor-pointer`}>
                        <a href='https://community.mansastars.com/home' className={`flex items-center ${isOpen ? ' space-x-6' : 'space-x-0'} `}>
            ...
            <div className={` flex ${isOpen ? 'px-4' : 'px-4 items-center justify-center'} mt-auto  py-2 mb-3 hover:bg-mansa-blue transition-all duration-200 cursor-pointer`}>
                <button onClick={handleLogout} className={`flex items-center ${isOpen ? ' space-x-6' : 'space-x-0'} `}>
