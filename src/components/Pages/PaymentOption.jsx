...
import { PricingFeatures, PricingPrice, PricingButton, PricingButtonPremium } from '../ReusableComponents/PricingResuables'
        ...
        {showBanner &&
            <div className=' bg-[#033CEE] w-full sticky top-0 z-50 text-white px-5 py-2 flex flex-col justify-between items-center'>
                <div className=' flex gap-3 items-center'>
                    <div className=' flex gap-3 items-center'>
                        <Tag size={30} />
                        <p className=' font-bold text-2xl max-sm:text-base'>Limited Time Offer! <span onClick={() => checkout(Number(23.99), userId)} className=' text-black underline cursor-pointer'>Subscribe</span> for only €23.99.</p>
                    </div>
                </div>
            ...
            <div className=' text-dark-blue flex flex-col items-center w-full gap-10 pb-20 overflow-y-auto'>
                        ...
                        <div className=' mt-auto'>
...

                            {
                                ...
                                <div className=' w-full'>
                                    <PricingButton
                                    text='Subscribe'
                                    onClick={() => checkout(Number(170.00), userId)}
                                    />
                                </div>
                            }
                        ...
                        <div>
...

                            {
                                ...
                                <div className=' w-full'>
                                    <PricingButtonPremium
                                    text='Subscribe'
                                    onClick={() => checkout(Number(300.00), userId)}
                                    />
                                </div>
                            }
                ...
                <div className=' flex flex-row max-sm:flex-col gap-3 items-center justify-center mt-10 mb-20 w-full'>
                    ...
                    <button className='uppercase shadow p-3 border-2 border-dark-blue rounded-lg bg-dark-blue text-white hover:bg-transparent hover:text-dark-blue transition-all duration-200'>
                            <a href="mailto:service@mansastars.com"><p className=' font-bold'>Talk to Us</p></a>
                    </button>
                </div>
            </div>
        </div>
