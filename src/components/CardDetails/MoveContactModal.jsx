...
function MoveContactModal({onClose}) {
    ...
    return (
      <div ref={moveContactModalRef} onClick={closeMoveContactModal} className=" fixed z-50 inset-0 bg-dark-blue bg-opacity-30 backdrop-blur-sm flex justify-center overflow-y-auto h-screen">
