  ...
  return (
    <div className=" m-auto">
      <div className="overflow-x-auto flex flex-col justify-center items-center">
        <h2 className="text-2xl font-bold text-left self-start">
          CSV File Fields
        </h2>
        <span className="text-base self-start mb-4">
          (Verify the contents of the file before final submission)
        </span>
        <Table striped>
      ...
      <Modal dismissible show={isEditing} onClose={() => setIsEditing(false)}>
        ...
        <Modal.Body className=" flex flex-col gap-5">
          ...
          <FullInput
            ...
            onChange={(e) =>
              setEditedData({ ...editedData, "first name": e.target.value })
            }
          />
          ...
          <FullInput
            ...
            onChange={(e) =>
              setEditedData({ ...editedData, "last name": e.target.value })
            }
          />
          ...
          <FullInput
            ...
            onChange={(e) =>
              setEditedData({ ...editedData, "phone number": e.target.value })
            }
          />
          {/* Other input fields */}
        </Modal.Body>
        <Modal.Footer className=" flex justify-between mx-10">
          <Button
            className=" bg-mansa-blue text-white w-40 font-bold"
            onClick={handleSave}
          >
            Save
          </Button>
          <Button
            className=" bg-red-500 text-white w-40 font-bold"
