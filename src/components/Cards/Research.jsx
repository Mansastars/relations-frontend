          ...
          >
            ...
            >
              <div className="flex justify-between w-full">
                <p className="font-extrabold text-sm text-white">
                  {`${research.first_name} ${research.last_name}`.length > 13
              ...
              <p className="text-sm text-white">
                {research.organization_name
                  ? research.organization_name.length > 15
                    ? research.organization_name.substring(0, 15) + "..."
                    : research.organization_name
                  : "No company entered"}
              </p>
            </div>
            <div className="flex flex-col gap-1 p-2 items-start bg-light-grey rounded-2xl">
              <div>
                <p className="text-xs font-semibold">
                  ...
                  {research.deal_size
                    ? research.deal_size.length > 15
                      ? "$" +
                        addCommasToNumber(research.deal_size.substring(0, 15)) +
                        "..."
                ...
                <p className="text-xs">
                  {research.email
                    ? truncateEmail(research.email, 20)
                    : "No email entered"}
                </p>
                <p className="text-xs">
              ...
              <div className="flex flex-col justify-center items-start">
                <p className="text-xs text-wrap">
                  {research.notes.length > 20
                    ? research.notes.substring(0, 20) + "..."
                    : research.notes}
                </p>
              </div>
            </div>
