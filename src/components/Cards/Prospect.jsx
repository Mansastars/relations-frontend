        ...
        <div className=" flex flex-col gap-5 items-center">
          ...
          <div style={{ overflowY: "auto", maxHeight: "calc(100vh - 100px)" }}>
            {prospects.map((prospect) => (
              <div
                key={prospect.id}
                onDoubleClick={() => handleEdit(prospect.id)}
              ...
              >
                  ...
                  <p className="text-sm text-white">
                    {prospect.organization_name
                      ? prospect.organization_name.length > 15
                        ? prospect.organization_name.substring(0, 15) + "..."
                        : prospect.organization_name
                      : "No company entered"}
                  </p>
                </div>
                <div className="flex flex-col gap-1 p-2 items-start bg-light-grey rounded-2xl">
                  <div>
                    <p className="text-xs font-semibold">
                      ...
                      {prospect.deal_size
                        ? prospect.deal_size.length > 15
                          ? "$" +
                            addCommasToNumber(
                              prospect.deal_size.substring(0, 15)
                            ) +
                            "..."
                    ...
                    <p className="text-xs">
                      {prospect.email
                        ? truncateEmail(prospect.email, 20)
                        : "No email entered"}
                    </p>
                    <p className="text-xs">
                  ...
                  <div className="flex flex-col justify-center items-start">
                    <p className="text-xs text-wrap">
                      {prospect.notes.length > 20
                        ? prospect.notes.substring(0, 20) + "..."
                        : prospect.notes}
                    </p>
                  </div>
                </div>
