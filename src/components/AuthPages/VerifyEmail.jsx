...
import { Button, SignUpRequired } from '../Reusables'
        ...
        <div className='bg-white px-5 py-8 flex flex-col mt-10 mb-5 rounded-2xl h-full w-1/2 max-lg:w-[70%] max-md:w-[90%]'>
            <div className=' flex flex-col justify-center items-center gap-10 h-fit '>
                <div className=' flex flex-col justify-center items-center'>
                    <h1 className=' text-dark-blue font-extrabold text-4xl max-sm:text-3xl mb-5 text-center'>Account Recovery</h1>
                ...
                <form onSubmit={ handleSubmit } className=' flex flex-col gap-16 justify-center items-center w-[80%]' >
